...
struct IConf {
	...
	float vib_bell_freq = 100; // Frequency to apply vibrato bell when all conditions met
	float vib_sbell_freq = 100; // Frequency to apply vibrato bell when all conditions met
	...
	float vib_bell1 = 20; // Maximum vibrato intensity in vibrato bell
	float vibf_bell1 = 20; // Max vibrato frequency in vibrato bell
	float vib_bell2 = 90; // Maximum vibrato intensity in vibrato bell
	float vibf_bell2 = 50; // Max vibrato frequency in vibrato bell
	float vib_sbell1 = 20; // Maximum vibrato intensity in vibrato bell for short notes
	float vibf_sbell1 = 20; // Max vibrato frequency in vibrato bell for short notes
	float vib_sbell2 = 90; // Maximum vibrato intensity in vibrato bell for short notes
	float vibf_sbell2 = 50; // Max vibrato frequency in vibrato bell for short notes
