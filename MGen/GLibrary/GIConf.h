...
struct IConf {
	...
	// For short notes
	float vib_sbell_top1 = 0; // Leftmost - rightmost maximum vibrato intensity in note(percent of note duration)
	float vib_sbell_top2 = 0; // Leftmost - rightmost maximum vibrato intensity in note(percent of note duration)
	float vibf_sbell_top1 = 0; // Leftmost - rightmost maximum vibrato speed in note(percent of note duration)
	float vibf_sbell_top2 = 0; // Leftmost - rightmost maximum vibrato speed in note(percent of note duration)
	...
	float vib_dyn1 = 0;
	float vib_dyn2 = 100;
	float vib_sdyn1 = 0; // For short notes
	float vib_sdyn2 = 100; // For short notes
