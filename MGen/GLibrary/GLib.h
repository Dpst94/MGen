...
public:
	...
	static float vol2db(int vol, int vol_default, float db_max, float db_coef);
	static int db2cc(float db, int vol_default, float db_max, float db_coef);
	static int CountCharacters(CString & st, char ch);
